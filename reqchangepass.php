...
<div class="col-sm-9 col-md-5"> <!-- Start User change password from 2nd column-->
	<form class="mt-5 mx-5" action="" method="POST">
		...
		<div class="form-group">
		<label for="inputnewpassword">New Password</label><input type="password"  class="form-control" name="rPassword" id="inputnewpassword">
		</div>
...
</div> <!-- End User change password from 2nd column-->
