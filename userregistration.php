	...
	<div class="row mt-4 mb-4">
		<div class="col-md-6 offset-md-3">
			<form action="" class="shadow" method="POST">
				...
				<div class="form-group">
				<i class="fas fa-key"></i> <label for="Password" class="font-weight-bold pl-2">New Password</label><input type="password" class="form-control" placeholder="Password" name="rPassword">	
				</div>
				<button type="submit" class="btn btn-success mt-5 btn-block shadow-sm font-weight-bold" name="rSignup">Sign Up</button><em style="font-size: 10px;">Note - By clicking sign up, you agree to our terms, data policy and cookie policy</em>
